...
import {type AppbarProps as Props, type AppbarCommands, type AppbarProps} from './Appbar.types';
...
const Appbar = ({
  ...
  const [blur, setBlur] = useState(isIos && initBlur);
  useFirstSkipChanged(() => setBlur(isIos && initBlur), [initBlur]);
...
export default withStaticProps(Appbar, {
