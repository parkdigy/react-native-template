...
import {type LayoutChangeEvent, type StyleProp, type TextStyle} from 'react-native';
...
import {type TextProps as Props} from './Text.types';
...
const Text = ({
  ...
  const lineHeightStyle = useMemo(() => {
    ...
    const finalLineHeight = Math.floor(
      newLh ?? customStyle.fontSize * _getFontLineHeightAdjustValue(customStyle.fontFamily),
    );
