...
import {type KeyboardAwareScrollViewProps as Props} from './KeyboardAwareScrollView.types';
  ...
  const keyboardShow = useCallback(
    (keyboardHeight: number) => {
      ...
      if (innerScrollViewRef.current && scrollViewTargetRef.current) {
        scrollViewTargetRef.current?.measureInWindow((scrollViewX, scrollViewY, scrollViewWidth, scrollViewHeight) => {
          if (Platform.OS === 'ios') {
