import {TextInput as NativeTextInput, type TextInputSubmitEditingEvent} from 'react-native';
import {TextInput, type TextInputProps} from 'react-native-paper';
import {useAppState} from '@context';
import {_getFontFamily} from '@types';
import CustomComponent from '../../CustomComponent';
import FormControl, {type FormControlCommands} from '../FormControl';
import {type FormTextProps as Props, type FormTextCommands, type FormTextValue} from './FormText.types';
...
const FormText = ({
  ...
  const finalStyle: Props['style'] = useMemo(() => [customStyle, otherStyle, style], [customStyle, otherStyle, style]);
...
export default withStaticProps(FormText, {
  Icon: TextInput.Icon,
